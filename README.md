...
This project solves the core Data Engineering problem that the Financial Services Industry faces today. Large number of customers that will benefit from using the our proposed architecture, design and end to end implementation are Brokers, Fund Managers, Asset Managers, Service Providers, Transfer Agents, Sponsors, Investment Managers and Hedge Funds and many other financial services players including regulators. 
